...
CREATE TABLE `co1706_cwk2`.`tbl_review` (`product_id` INT NOT NULL , `name` VARCHAR(50) NOT NULL , `description` VARCHAR(500) NOT NULL , `rating` INT NOT NULL ) ENGINE = InnoDB;
INSERT INTO `tbl_review` (`product_id`, `name`, `description`, `rating`) VALUES ('1', 'ROHIT', 'Fabrics is very nice', '4');
-- --------------------------------------------------------
